<template>
    ...
    <div class="center-view" >
      <div class="avatar"  data-click-fun="track_f_354894">
        <img @click="handleLogin"
          ...
          class="avator-icon"
        />
        <div @click="handleLogin" class="nick-name">立即登录</div>
      </div>
      <ul class="my-order-tab">
        <li  data-click-fun="track_f_323503">
          <img
        ...
        <li  data-click-fun="track_f_61077">
          <img
      ...
      <!---->
      <div class="margin-set my-card"  data-click-fun="track_f_595508">
        <img
      ...
      <div class="margin-set my-card"  data-click-fun="track_f_938331">
        <img
...
.center-view .my-balance, .center-view .my-card {
    position: relative;
}
...
.center-view .my-balance:after, .center-view .my-card:after {
    content: " ";
    position: absolute;
    left: 0;
    bottom: 0;
...
.center-view .my-balance .value .price-decimal, .center-view .my-card .value .price-decimal {
    color: #797d82;
}
.price-fmt {
    font-size: 15px;
